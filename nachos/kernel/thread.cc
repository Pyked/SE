...
void Thread::SaveProcessorState() {
    // Sauvegarder l'état du processeur RISC-V émulé pour le thread courant
    ASSERT(g_current_thread == this); // S'assurer que le thread courant est bien celui-ci

    // Sauvegarder le contexte du processeur RISC-V émulé
    g_machine->GetRISC()->SaveState();
}
#endif*/
//----------------------------------------------------------------------
...
void Thread::RestoreProcessorState() {
    // Restaurer l'état sauvegardé du processeur RISC-V émulé pour le thread courant
    ASSERT(g_current_thread == this); // S'assurer que le thread courant est bien celui-ci

    // Restaurer le contexte du processeur RISC-V émulé
    g_machine->GetRISC()->RestoreState();
}
#endif*/
//----------------------------------------------------------------------
